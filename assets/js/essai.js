...
'https://airlabs.co/api/v9/schedules?api_key=3ad9a21f-89ba-4fdb-85d8-3fb7767bf5a8&dep_iata=CDG');
    console.log(request);
    ...
    values = [];
    for (i = 0; i < length; i++) {
        labels.push(request.response[i].airline_icao);
        values.push(request.response[i].flight_number);
    }
